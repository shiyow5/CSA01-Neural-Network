...
SRC = "report_TP2.md"
DST = "report_TP2.pdf"
HTML_TMP = os.path.abspath("report_TP2_tmp.html")
CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"

# --- Step 1: Markdown -> HTML body (pandoc, embed images) ---
body_tmp = "report_TP2_body.html"
subprocess.run(
    ["pandoc", SRC, "-o", body_tmp, "--embed-resources", "--standalone",
     "--mathml"],
    check=True
)
...
# --- Step 2: Wrap with CSS for nice PDF ---
...
body {{
    font-family: "Hiragino Mincho ProN", "Hiragino Sans", "Yu Gothic", serif;
    font-size: 10.5pt;
    line-height: 1.75;
    color: #222;
}}
